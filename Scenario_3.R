...
covariates <- as.matrix(final_data[, c("CPI_diff", "Unemployment_Rate", "Capacity_Utilization_diff")])
...
scenario_3_table[, -1] <- lapply(scenario_3_table[, -1], function(x) format(x, scientific = TRUE, digits = 4))
