...
covariates <- as.matrix(final_data[, c("Yield_5y", "Yield_7y","repo_Rate")])
...
scenario_4_table[, -1] <- lapply(scenario_4_table[, -1], function(x) format(x, scientific = TRUE, digits = 4))
