...
covariates <- as.matrix(final_data[, c("Level", "Slope", "Curvature","CPI_diff", "Unemployment_Rate", "Capacity_Utilization_diff")])  # Convert covariates to matrix
...
scenario_2_table[, -1] <- lapply(scenario_2_table[, -1], function(x) format(x, scientific = TRUE, digits = 4))
