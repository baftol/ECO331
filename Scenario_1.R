...
covariates <- as.matrix(final_data[, c("Level", "Slope", "Curvature")])  # Convert covariates to matrix
...
scenario_1_table[, -1] <- lapply(scenario_1_table[, -1], function(x) format(x, scientific = TRUE, digits = 4))

# Display the formatted table
print(scenario_1_table)
