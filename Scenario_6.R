...
covariates <- as.matrix(final_data[, c("Level", "Slope", "Curvature","CPI_diff", "Unemployment_Rate", "Capacity_Utilization_diff", "Yield_5y","Yield_7y","repo_Rate")])
...
scenario_6_table[, -1] <- lapply(scenario_6_table[, -1], function(x) format(x, scientific = TRUE, digits = 4))

# Display the formatted table
print(scenario_6_table)
